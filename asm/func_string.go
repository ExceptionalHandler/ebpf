...
=======
	_ = x[WindowsFnMapLookupElem-16777217]
	_ = x[WindowsFnMapUpdateElem-16777218]
	_ = x[WindowsFnMapDeleteElem-16777219]
	_ = x[WindowsFnMapLookupAndDeleteElem-16777220]
	_ = x[WindowsFnTailCall-16777221]
	_ = x[WindowsFnGetPrandomU32-16777222]
	_ = x[WindowsFnKtimeGetBootNs-16777223]
	_ = x[WindowsFnGetSmpProcessorId-16777224]
	_ = x[WindowsFnKtimeGetNs-16777225]
	_ = x[WindowsFnCsumDiff-16777226]
	_ = x[WindowsFnRingbufOutput-16777227]
	_ = x[WindowsFnTracePrintk2-16777228]
	_ = x[WindowsFnTracePrintk3-16777229]
	_ = x[WindowsFnTracePrintk4-16777230]
	_ = x[WindowsFnTracePrintk5-16777231]
	_ = x[WindowsFnMapPushElem-16777232]
	_ = x[WindowsFnMapPopElem-16777233]
	_ = x[WindowsFnMapPeekElem-16777234]
	_ = x[WindowsFnGetCurrentPidTgid-16777235]
	_ = x[WindowsFnGetCurrentLogonId-16777236]
	_ = x[WindowsFnIsCurrentAdmin-16777237]
	_ = x[WindowsFnMemcpy-16777238]
	_ = x[WindowsFnMemcmp-16777239]
	_ = x[WindowsFnMemset-16777240]
	_ = x[WindowsFnMemmove-16777241]
	_ = x[WindowsFnGetSocketCookie-16777242]
	_ = x[WindowsFnStrncpyS-16777243]
	_ = x[WindowsFnStrncatS-16777244]
	_ = x[WindowsFnStrnlenS-16777245]
	_ = x[WindowsFnKtimeGetBootMs-16777246]
	_ = x[WindowsFnKtimeGetMs-16777247]
}
